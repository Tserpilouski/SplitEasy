  ...
  const features = [
    {
      ...
      description:
        'Делите счета поровну или настраивайте индивидуальные доли для каждого участника',
    },
    {
      icon: Users,
      title: 'Групповые поездки',
      description:
        'Идеально для путешествий, корпоративов и совместных покупок с друзьями',
    },
    {
      icon: PieChart,
      title: 'Прозрачная статистика',
      description:
        'Наглядные графики и автоматический расчет, кто кому и сколько должен',
    },
  ];
        ...
        <section className="py-20 md:py-32 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Забудьте о сложных расчетах в путешествиях и совместных покупках.
              SplitEasy автоматически считает, кто кому должен.
            </p>
        ...
        <section className="py-20 text-center">
          <div className="max-w-3xl mx-auto p-12 from-primary/10 to-purple-500/10 rounded-2xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Присоединяйтесь к тысячам пользователей, которые уже упростили
              деление расходов
            </p>
            <Link to="/dashboard">
